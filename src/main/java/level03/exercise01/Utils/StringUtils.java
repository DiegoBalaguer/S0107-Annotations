...
public class StringUtils {
    ...
    public static String generateRandomString(int quantity) {
        ...
        for (int i = 0; i < quantity; i++) {
            ...
            // 2 -> between a y z
            // 3 -> between 0 y 9
            int type = level02.exercise01.Utils.NumberUtils.random(1, 3);
            switch (type) {
                case 1 -> letter = (char) level02.exercise01.Utils.NumberUtils.random('A', 'Z');
                case 2 -> letter = (char) level02.exercise01.Utils.NumberUtils.random('a', 'z');
                case 3 -> letter = (char) level02.exercise01.Utils.NumberUtils.random('0', '9');
            }
    ...
    public static String generateRandomStringCapsNums(int quantity) {
        ...
        for (int i = 0; i < quantity; i++) {
            int type = level02.exercise01.Utils.NumberUtils.random(1, 2);
            switch (type) {
                case 1 -> letter = (char) level02.exercise01.Utils.NumberUtils.random('A', 'Z');
